...
public class ExchangeRateService {
    ...
    public CountrySummary.ExchangeRateInfo parseResponse(String json) throws Exception {
    ...
    private CountrySummary.ExchangeRateInfo mapToExchangeRateInfo(ExchangeRateApiResponse response) {
